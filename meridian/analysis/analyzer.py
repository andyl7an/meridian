...
class Analyzer:
  ...
  def _get_hill_curves_dataframe(
    ...
    Args:
      channel_type: Type of channel, either `media`, `rf`, `organic_media`, or
        `organic_rf`.
    ...
    Returns:
      ...
      *   channel_type: Indication of a `media`, `rf`, `organic_media`, or
        `organic_rf` channel.
